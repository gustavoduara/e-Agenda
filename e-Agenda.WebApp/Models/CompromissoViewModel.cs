...
namespace e_Agenda.ConsoleApp.Models
{
    ...
    public class DetalhesCompromissoViewModel
    {
        ...
        public DetalhesCompromissoViewModel(Guid id, string assunto, DateTime dataOcorrencia, DateTime horaInicio, DateTime horaTermino, string tipoCompromisso, string local, string link, Guid contatoId)
        {
            Id = id;
            Assunto = assunto;
